...
Capsule Network, SegAN, and MultiResUNet to solve skin lesion analysis problems using a dermatoscopic image that contains a skin tumor.
...
Capsule Network, SegAN et MultiResUNet pour résoudre les problèmes d'analyse des lésions cutanées à l'aide d'une image dermatoscopique contenant une tumeur cutanée.
